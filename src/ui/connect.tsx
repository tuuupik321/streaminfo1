      ...
      <div className="connect-card">
        ...
        <div className="connect-utility-row">
          ...
          <span className="platform-pill neutral">
            ...
            Донаты подключим следующим шагом
          </span>
        </div>
        ...
        <div className="connect-next-step">
          <div>
            ...
            <span>
              После канала стоит подключить Telegram и DonateAlerts, чтобы публиковать ссылку на эфир и видеть поддержку зрителей в одном месте.
            </span>
          </div>
          {isDev ? (
            ...
            <span className="connect-next-step-badge">Сначала подключаем основной канал</span>
          )}
        </div>
